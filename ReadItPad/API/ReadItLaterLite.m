...
static NSString *apikey = @"c4cT2O05g03f2r969bdc0x9LeDpbm4e7";			//Enter your apikey here : get one at http://readitlaterlist.com/api/ 
static NSString *nameOfYourApp = @"ReadItOnIpad";		//Enter the name of your application here (optional - for user-agent string)
...
//    self.apiResponse = [NSDictionary dictionaryWithObjectsAndKeys:@"X-Error",[error description]];
	[self finishConnection];
	[connection release];	
}
...
-(void)finishConnection {
    ...
    {  
        selector = @selector(readitLaterGetFinished:error:);
    }
